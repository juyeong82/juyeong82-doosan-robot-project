            ...
            if not task_running:
                ...
                try:
                    ...
                    def oiling_pick(logger):
                        ...
                        pub_feedback("오일링 도구 집기 시작", 0.0) # [0%])
                    ...
                    def oiling_move(logger, num_strokes, y_step_size, move_x, vel_x, acc_x, vel_y, acc_y, vel_z, acc_z):
                        ...
                        pub_feedback("오일링 1번째 줄 작업 중", 30.0) # [30%]
                        ...
                        pub_feedback("오일링 2번째 줄 작업 중", 60.0) # [60%]
                        ...
                        pub_feedback("오일링 3번째 줄 작업 중", 90.0) # [90%]
                    ...
                    def oiling_place(logger):
                        pub_feedback("도구 내려놓기 이동", 95.0) # [95%]
                        ...
                        gripper(1)
                        pub_feedback("오일링 공정 완료", 100.0) # [100%]
